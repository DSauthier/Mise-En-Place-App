...
router.post('/recipes/create',uploadCloud.single('image'), (req, res, next) => {
...
router.post('/:_id/update', uploadCloud.single('image'), (req, res, next) => {
...
router.get('/:id', (req, res, next) => {
  ...
  Recipe.findById(req.params.id).populate('author')
    .then((theRecipe) => {
      ...
      data = { theRecipe: theRecipe, canDelete: canDelete, canEdit: canEdit, theIngredients, theDirection };
      // console.log(data)
